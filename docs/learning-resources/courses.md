...
*List of available free online courses([MOOC](https://en.wikipedia.org/wiki/Massive_open_online_course)) and tutorials*
  ...
  - [Complete Kubernetes Course in French (Free)](https://blog.stephane-robert.info/docs/containers/kubernetes/introduction/) - A free and complete Kubernetes course in French covering core concepts, advanced usage, and practical examples.
