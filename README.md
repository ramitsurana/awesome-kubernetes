...
* [Getting Started with Kubernetes (With examples in Google Kubernetes Engine)](https://www.manning.com/books/getting-started-with-kubernetes) by [William Denniss]
