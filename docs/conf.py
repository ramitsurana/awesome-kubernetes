...
project = u'Awesome Kubernetes'
copyright = u'2019, Ramit Surana'
author = u'Ramit Surana'
...
latex_documents = [
    (master_doc, 'SphinxwithMarkdown.tex', u'Awesome Kubernetes',
     u'Ramit Surana', 'manual'),
]
...
man_pages = [
    (master_doc, 'sphinxwithmarkdown', u'Awesome Kubernetes',
     [author], 1)
]
